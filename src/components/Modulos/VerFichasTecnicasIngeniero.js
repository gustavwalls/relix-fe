...
function VerFichasTecnicasIngeniero() {
  ...
  return (
    ...
    <div className="container-fluid pt-4 ">
      <TitlePage title="Ficha Técnica de Proyecto - Ingeniero" />
      <div className="row">
        <FichasTecnicasAcordeon title ='Fichas tecnicas Ingeniero' loading={loading}
